...
GuiBuilderMain.prototype.buildPanelChangeFile = function(executeScript){
    ...
    if (executeScript === "Set canvas by biggest edges"){
        #include "../executeScript/Set canvas by biggest edges/Set canvas by biggest edges - UI.jsx";
    }
    ...
    if (executeScript === "Set image size"){
        #include "../executeScript/Set image size/Set image size - UI.jsx";
    }
}
