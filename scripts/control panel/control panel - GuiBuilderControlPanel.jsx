...
GuiBuilderControlPanel.prototype.buildControlPanel = function () {
    ...
    this.btnSetBiggestEdgesOnCanvas = this.controlPanelWindow.add("button", [0, 40, 190, 61], "Set biggest edges on canvas");

    this.btnResizeImage = this.controlPanelWindow.add("button", [205, 80, 395, 101], "Resize image");

    this.btn2toNcanvas = this.controlPanelWindow.add("button", [205, 80, 395, 101], "2^n canvas");

    this.btnSettings = this.controlPanelWindow.add("button", [205, 120, 395, 141], "Settings");
