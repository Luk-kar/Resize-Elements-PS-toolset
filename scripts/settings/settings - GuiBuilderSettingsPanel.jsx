...
GuiBuilderSettingsPanel.prototype.buildSettingsPanel = function() {
    ...
    var PNGbyDefault_boolValue = readValueOfSeetingsFromPrefFile(prefFileKeys.filterByPNG);
    ...
    var DoNotShowCloseOpenedFiles_boolValue = readValueOfSeetingsFromPrefFile(prefFileKeys.closeDialogOpenFiles);
