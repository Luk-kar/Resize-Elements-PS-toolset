...
GuiBuilderSettingsPanel.prototype.buildSettingsPanel = function() {
    ...
    var PNGbyDefault_boolValue = readValueOfSeetingsFromPrefFile(prefFileKeys.filterByPNG, userDataFolder);
    ...
    var DoNotShowCloseOpenedFiles_boolValue = readValueOfSeetingsFromPrefFile(prefFileKeys.closeDialogOpenFiles, userDataFolder);
